...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::String(StrId::STR_STARTUP_SYNC_SERVER_URL, SETTINGS.startupSyncServerUrl,
                            sizeof(SETTINGS.startupSyncServerUrl), "startupSyncServerUrl", StrId::STR_CAT_SYSTEM),
